...
import (
	"github.com/eloycoto/gsoc_examples/pkg/api"
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *EFoo) DeepCopyInto(out *EFoo) {
	*out = *in
	if in.Foo != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new EFoo.
func (in *EFoo) DeepCopy() *EFoo {
	if in == nil {
		return nil
	}
	out := new(EFoo)
